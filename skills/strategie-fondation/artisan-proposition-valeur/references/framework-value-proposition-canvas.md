...
Ce framework fait partie du skill **Artisan de Proposition de Valeur** et fournit une méthodologie structurée pour élaboration socratique de la proposition de valeur avec value proposition canvas.
...
*Framework Value Proposition Canvas - Hacienda Marketing Pack v1.0.0*
