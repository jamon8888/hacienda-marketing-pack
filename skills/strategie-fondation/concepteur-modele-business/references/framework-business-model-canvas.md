...
Ce framework fait partie du skill **Concepteur de Modèle Business** et fournit une méthodologie structurée pour co-construction socratique du business model canvas et lean canvas.
...
*Framework Business Model Canvas - Hacienda Marketing Pack v1.0.0*
