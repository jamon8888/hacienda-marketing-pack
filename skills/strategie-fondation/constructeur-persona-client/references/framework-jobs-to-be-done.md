...
Ce framework fait partie du skill **Constructeur de Persona Client** et fournit une méthodologie structurée pour création socratique de personas avec jobs-to-be-done et empathy map.
...
*Framework Jobs To Be Done - Hacienda Marketing Pack v1.0.0*
